[
    ...
    {
        trigger: /([pbBvV]mat|matrix|cases|align|array)/,
        replacement: "\\begin{[[0]]}\n$0\n\\end{[[0]]}",
        options: "rMA",
        description: "Matrix and other environments with new lines",
    },
    {
        trigger: /([pbBvV]mat|matrix|cases|align|array)/,
        replacement: "\\begin{[[0]]}$0end{[[0]]}",
        options: "rnA",
    },
