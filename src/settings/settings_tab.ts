...
export class LatexSuiteSettingTab extends PluginSettingTab {
	...
	private displayAdvancedSnippetSettings() {
		...
		new Setting(containerEl)
			...
			.setDesc("Set the level of debug information to log about snippet expansion. Set to \"info\" or \"verbose\" to help identify issues with snippet syntax or why a snippet is not expanding.")
			.addDropdown((dropdown) => dropdown
				.addOption("off", "Off")
				.addOption("info", "Info")
