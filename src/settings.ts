...
export class LatexSuiteSettingTab extends PluginSettingTab {
	...
	display(): void {
		...
		snippetsFileLoc.addText((text) => {
			text.setPlaceholder(DEFAULT_SETTINGS.snippetsFileLocation)
		...
		containerEl
			.createEl("div", { text: "Inline math preview" })
			.addClasses([
				"setting-item",
				"setting-item-heading",
				"setting-item-name",
		...
		new Setting(containerEl)
			.setName("Enabled")
			.setDesc(
				"When inside inline math, show a popup preview window of the rendered math."
			)
			.addToggle((toggle) =>
				toggle
